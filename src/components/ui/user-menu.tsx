...
export const UserMenu: React.FC<UserMenuProps> = ({
  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent
        className={`w-56 transition-opacity ${
          isLoggingOut ? "opacity-60 pointer-events-none" : "opacity-100"
        }`}
        align="end"
        forceMount
      >
        ...
        <div className="flex items-center gap-2 p-2">
          ...
          {/* Mentor Status Pill */}
          {mentorStatus === "approved" && (
            <span className="ml-auto rounded-full bg-emerald-100 text-emerald-700 text-xs px-2 py-0.5">
              Mentor
            </span>
          )}
          {mentorStatus === "pending" && (
        ...
        {mentorStatus === "approved" ? (
          <DropdownMenuItem onSelect={() => navigate("/dashboard/mentor")}>
            <LayoutDashboard className="mr-2 h-4 w-4" />
            Mentor Dashboard
          </DropdownMenuItem>
        ) : mentorStatus === "pending" ? (
