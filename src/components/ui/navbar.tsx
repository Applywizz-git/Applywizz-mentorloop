...
//   return (
// <nav className="relative flex flex-row items-center justify-between px-4 sm:px-6 py-4 bg-white border-b border-border">

    
//     {/* 🔸 Top Row (Logo + Auth Buttons) for Mobile */}
...
//   {/* RIGHT: UserMenu (mobile & desktop both) */}
//   {isLoggedIn && !loading && (
...
//       <Link to="/login">
//         <span className="font-medium text-foreground text-sm">Login</span>
//       </Link>
//       <Link to="/login">
//         <button className="aw-btn-primary text-xs px-3 py-1.5 rounded-full">
//           Get Started
//         </button>
//       </Link>
//     </div>
...
//     {/* ✅ MOBILE NAV LINKS - Below Logo + Auth */}
//     {/* <div className="flex flex-wrap md:hidden w-full mt-3 gap-x-4 gap-y-2 text-sm justify-center">
//       {isMentorApproved ? (
//         <Link
//           to="/dashboard/mentor"
//           className="text-foreground hover:text-primary transition-colors"
...
//           </Link>
//           <Link to="/login">
//             <button className="aw-btn-primary text-sm px-5 py-2">
//               Get Started
//             </button>
//           </Link>
//         </>
...
//           </Link>
//           <Link to="/login">
//         <button className="aw-btn-primary text-sm px-5 py-2 whitespace-nowrap">
//       Get Started
//     </button>
//           </Link>
//         </>
...
export const Navbar: React.FC<NavbarProps> = ({ unreadCount }) => {
  ...
  return (
    <nav className="relative flex items-center justify-between px-6 py-4 bg-white border-b border-border">
  {/* LEFT: Logo */}
  <Link to="/" className="flex items-center gap-3">
    <img src={logo} alt="ApplyWizz" className="h-8 w-auto" />
    <span className="text-xl font-bold text-foreground">APPLY WIZZ</span>
  ...
  {/* CENTER: Absolute centered nav links */}
